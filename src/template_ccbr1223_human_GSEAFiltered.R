# GSEA Filters - Sugarloaf V1 [CCBR] [Legacy] (d3c1d012-4ecd-4ac3-9e85-fd68cda28ba0): v128
ccbr1223_human_GSEAFiltered <- function(ccbr1223_human_GSEAPreranked, msigdb_v6_2_with_orthologs ) {
...
# Primary inputs
gsea_table <- ccbr1223_human_GSEAPreranked
...
print("template_ccbr1223_human_GSEAFiltered.R #########################################################################")
...
# Processing input variable: var_ccbr1223_human_GSEAPreranked
var_ccbr1223_human_GSEAPreranked<-readRDS(paste0(rds_output,"/var_ccbr1223_human_GSEAPreranked.rds"))

if (!('Seurat' %in% class(var_ccbr1223_human_GSEAPreranked))) { if (!(class(var_ccbr1223_human_GSEAPreranked) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_human_GSEAPreranked <- as.data.frame(var_ccbr1223_human_GSEAPreranked)}}
#############################
...
var_ccbr1223_human_GSEAFiltered<-ccbr1223_human_GSEAFiltered(var_ccbr1223_human_GSEAPreranked,var_msigdb_v6_2_with_orthologs)
saveRDS(var_ccbr1223_human_GSEAFiltered, paste0(rds_output,"/var_ccbr1223_human_GSEAFiltered.rds"))
