...
ccbr1223_mouse_GSEAFiltered <- function(ccbr1223_mouse_GSEAPreranked, msigdb_v6_2_with_orthologs ) {
...
# Primary inputs
gsea_table <- ccbr1223_mouse_GSEAPreranked
...
print("template_ccbr1223_mouse_GSEAFiltered.R #########################################################################")
...
# Processing input variable: var_ccbr1223_mouse_GSEAPreranked
var_ccbr1223_mouse_GSEAPreranked<-readRDS(paste0(rds_output,"/var_ccbr1223_mouse_GSEAPreranked.rds"))

if (!('Seurat' %in% class(var_ccbr1223_mouse_GSEAPreranked))) { if (!(class(var_ccbr1223_mouse_GSEAPreranked) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_mouse_GSEAPreranked <- as.data.frame(var_ccbr1223_mouse_GSEAPreranked)}}
#############################
...
var_ccbr1223_mouse_GSEAFiltered<-ccbr1223_mouse_GSEAFiltered(var_ccbr1223_mouse_GSEAPreranked,var_msigdb_v6_2_with_orthologs)
saveRDS(var_ccbr1223_mouse_GSEAFiltered, paste0(rds_output,"/var_ccbr1223_mouse_GSEAFiltered.rds"))
