# Filter Low Counts [CCBR] (59e7ee62-1715-4276-b370-e8395168f9d8): v733
ccbr1223_mouse_FilteredCounts <- function(ccbr1223_mouse_CleanRawCounts, ccbr1223_mouse_metadata) {
    ...
    #Basic Parameters:
    counts_matrix = ccbr1223_mouse_CleanRawCounts
...
#print(colnames(df.final))
    ...
    png(
      filename="ccbr1223_mouse_FilteredCounts.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_ccbr1223_mouse_FilteredCounts.R #########################################################################")
...
# Processing input variable: var_ccbr1223_mouse_CleanRawCounts
var_ccbr1223_mouse_CleanRawCounts<-readRDS(paste0(rds_output,"/var_ccbr1223_mouse_CleanRawCounts.rds"))

if (!('Seurat' %in% class(var_ccbr1223_mouse_CleanRawCounts))) { if (!(class(var_ccbr1223_mouse_CleanRawCounts) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_mouse_CleanRawCounts <- as.data.frame(var_ccbr1223_mouse_CleanRawCounts)}}
#############################
...
var_ccbr1223_mouse_FilteredCounts<-ccbr1223_mouse_FilteredCounts(var_ccbr1223_mouse_CleanRawCounts,var_ccbr1223_mouse_metadata)
saveRDS(var_ccbr1223_mouse_FilteredCounts, paste0(rds_output,"/var_ccbr1223_mouse_FilteredCounts.rds"))
