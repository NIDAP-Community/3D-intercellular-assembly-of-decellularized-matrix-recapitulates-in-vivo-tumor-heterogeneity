...
ccbr1223_mouse_NormalizedCounts <- function(ccbr1223_mouse_FilteredCounts, ccbr1223_mouse_metadata) {
    ...
    #Basic Parameters:
    counts_matrix <- ccbr1223_mouse_FilteredCounts
...
counts_matrix[,gene_names_column]=paste0(counts_matrix[,gene_names_column],'_',1:nrow(counts_matrix))
    ...
    png(
      filename="ccbr1223_mouse_NormalizedCounts.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_ccbr1223_mouse_NormalizedCounts.R #########################################################################")
...
# Processing input variable: var_ccbr1223_mouse_FilteredCounts
var_ccbr1223_mouse_FilteredCounts<-readRDS(paste0(rds_output,"/var_ccbr1223_mouse_FilteredCounts.rds"))

if (!('Seurat' %in% class(var_ccbr1223_mouse_FilteredCounts))) { if (!(class(var_ccbr1223_mouse_FilteredCounts) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_mouse_FilteredCounts <- as.data.frame(var_ccbr1223_mouse_FilteredCounts)}}
#############################
...
var_ccbr1223_mouse_NormalizedCounts<-ccbr1223_mouse_NormalizedCounts(var_ccbr1223_mouse_FilteredCounts,var_ccbr1223_mouse_metadata)
saveRDS(var_ccbr1223_mouse_NormalizedCounts, paste0(rds_output,"/var_ccbr1223_mouse_NormalizedCounts.rds"))
