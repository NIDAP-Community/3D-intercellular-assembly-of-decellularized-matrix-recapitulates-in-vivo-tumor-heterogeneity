...
ccbr1223_mouse_GSEAPreranked <- function(ccbr1223_mouse_DEG, msigdb_v6_2_with_orthologs) {
...
#image: png
png(
  filename = "ccbr1223_mouse_GSEAPreranked.png",
  width = image_width,
  height = image_height,
  units = "px",
  pointsize = 4,
...
print("template_ccbr1223_mouse_GSEAPreranked.R #########################################################################")
...
var_ccbr1223_mouse_GSEAPreranked<-ccbr1223_mouse_GSEAPreranked(var_ccbr1223_mouse_DEG,var_msigdb_v6_2_with_orthologs)
saveRDS(var_ccbr1223_mouse_GSEAPreranked, paste0(rds_output,"/var_ccbr1223_mouse_GSEAPreranked.rds"))
