...
ccbr1223_mouse_GSEAVisualization <- function(ccbr1223_mouse_DEG, ccbr1223_mouse_GSEAFiltered, ccbr1223_mouse_BatchCorrectedCounts, ccbr1223_mouse_metadata, msigdb_v6_2_with_orthologs) {
...
## PARAMETERS
    ...
    genescore_df <- ccbr1223_mouse_DEG
    gex_df <- ccbr1223_mouse_BatchCorrectedCounts
    metadata_df <- ccbr1223_mouse_metadata
    gsea_df <- ccbr1223_mouse_GSEAFiltered
...
if (grepl("LE", which_plot)) {
    ...
    samples_to_include = setdiff(c("CA_MC38_1","CA_MC38_2","CA_MC38_3","CA_MC38_4","CA_MC38_5","ECM_MC38_1","ECM_MC38_3","ECM_MC38_4","ECM_MC38_5","ECM_MC38_6","CA_CT26_1","CA_CT26_2","CA_CT26_3","CA_CT26_4","CA_CT26_5","CA_CT26_6","ECM_CT26_1","ECM_CT26_2","ECM_CT26_3","ECM_CT26_4","ECM_CT26_5","ECM_CT26_6"), geneid)
...
png(filename="ccbr1223_mouse_GSEAVisualization.png", width=(pageWidth+5)*300, height=(pageHeight+5)*300, units="px", pointsize=4, bg="white", res=300, type="cairo") 
print(preview)
...
print("template_ccbr1223_mouse_GSEAVisualization.R #########################################################################")
...
# Processing input variable: var_ccbr1223_mouse_GSEAFiltered
var_ccbr1223_mouse_GSEAFiltered<-readRDS(paste0(rds_output,"/var_ccbr1223_mouse_GSEAFiltered.rds"))

if (!('Seurat' %in% class(var_ccbr1223_mouse_GSEAFiltered))) { if (!(class(var_ccbr1223_mouse_GSEAFiltered) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_mouse_GSEAFiltered <- as.data.frame(var_ccbr1223_mouse_GSEAFiltered)}}
#############################
...
var_ccbr1223_mouse_GSEAVisualization<-ccbr1223_mouse_GSEAVisualization(var_ccbr1223_mouse_DEG,var_ccbr1223_mouse_GSEAFiltered,var_ccbr1223_mouse_BatchCorrectedCounts,var_ccbr1223_mouse_metadata,var_msigdb_v6_2_with_orthologs)
saveRDS(var_ccbr1223_mouse_GSEAVisualization, paste0(rds_output,"/var_ccbr1223_mouse_GSEAVisualization.rds"))
