# GSEA Preranked - Sugarloaf V1 [CCBR] (7ae8d90f-c3a2-4684-aa30-00751f0d2c56): v195
ccbr1223_human_GSEAPreranked <- function(ccbr1223_human_DEG, msigdb_v6_2_with_orthologs) {
...
#image: png
png(
  filename = "ccbr1223_human_GSEAPreranked.png",
  width = image_width,
  height = image_height,
  units = "px",
  pointsize = 4,
...
print("template_ccbr1223_human_GSEAPreranked.R #########################################################################")
...
var_ccbr1223_human_GSEAPreranked<-ccbr1223_human_GSEAPreranked(var_ccbr1223_human_DEG,var_msigdb_v6_2_with_orthologs)
saveRDS(var_ccbr1223_human_GSEAPreranked, paste0(rds_output,"/var_ccbr1223_human_GSEAPreranked.rds"))
