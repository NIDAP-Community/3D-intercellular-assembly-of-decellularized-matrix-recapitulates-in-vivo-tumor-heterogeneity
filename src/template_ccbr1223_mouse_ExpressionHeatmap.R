...
ccbr1223_mouse_ExpressionHeatmap <- function(ccbr1223_mouse_BatchCorrectedCounts,ccbr1223_mouse_metadata) {
...
print("template_ccbr1223_mouse_ExpressionHeatmap.R #########################################################################")
...
var_ccbr1223_mouse_ExpressionHeatmap<-ccbr1223_mouse_ExpressionHeatmap(var_ccbr1223_mouse_BatchCorrectedCounts,var_ccbr1223_mouse_metadata)
saveRDS(var_ccbr1223_mouse_ExpressionHeatmap, paste0(rds_output,"/var_ccbr1223_mouse_ExpressionHeatmap.rds"))
