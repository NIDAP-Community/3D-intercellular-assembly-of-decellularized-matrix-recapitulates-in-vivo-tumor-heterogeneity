...
ccbr1223_mouse_DEG <- function(ccbr1223_mouse_FilteredCounts, ccbr1223_mouse_metadata) {
    ...
    contrast_variable_column<-c("Treatment_CellLine")
    contrasts<-c("ECM_MC38-CA_MC38","ECM_CT26-CA_CT26")
    covariates_columns=c("Treatment_CellLine")
...
print("template_ccbr1223_mouse_DEG.R #########################################################################")
...
var_ccbr1223_mouse_DEG<-ccbr1223_mouse_DEG(var_ccbr1223_mouse_FilteredCounts,var_ccbr1223_mouse_metadata)
saveRDS(var_ccbr1223_mouse_DEG, paste0(rds_output,"/var_ccbr1223_mouse_DEG.rds"))
