...
ccbr1223_human_Volcano <- function(ccbr1223_human_DEG) {
    # image: png
    ...
    #Basic Parameters:
    df.orig <- ccbr1223_human_DEG
    label.col <- "Gene"
    sig.col <- c("ECM_HT29-CA_HT29_pval")
    pCutoff  = 0.001
    lfc.col <- c("ECM_HT29-CA_HT29_logFC")
    FCcutoff = 1.0
...
print("template_ccbr1223_human_Volcano.R #########################################################################")
...
var_ccbr1223_human_Volcano<-ccbr1223_human_Volcano(var_ccbr1223_human_DEG)
saveRDS(var_ccbr1223_human_Volcano, paste0(rds_output,"/var_ccbr1223_human_Volcano.rds"))
