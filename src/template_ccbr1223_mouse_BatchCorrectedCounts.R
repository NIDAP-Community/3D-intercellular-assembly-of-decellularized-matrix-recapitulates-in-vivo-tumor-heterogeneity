...
ccbr1223_mouse_BatchCorrectedCounts <- function(ccbr1223_mouse_NormalizedCounts, ccbr1223_mouse_metadata) {
    ...
    #Basic Parameters:
    counts_matrix <- ccbr1223_mouse_NormalizedCounts
    sample_metadata <- ccbr1223_mouse_metadata
    gene_names_column <- "Gene" 
    columns_to_include <- c("Gene","Ensembl_ID_version","Ensembl_ID","CA_MC38_1","CA_MC38_2","CA_MC38_3","CA_MC38_4","CA_MC38_5","ECM_MC38_1","ECM_MC38_3","ECM_MC38_4","ECM_MC38_5","ECM_MC38_6","CA_CT26_1","CA_CT26_2","CA_CT26_3","CA_CT26_4","CA_CT26_5","CA_CT26_6","ECM_CT26_1","ECM_CT26_2","ECM_CT26_3","ECM_CT26_4","ECM_CT26_5","ECM_CT26_6")
    sample_names_column <- "Sample"
 
    groups_column <- "Treatment_CellLine"
    covariates <- c("Treatment_CellLine")
    ...
    png(
      filename="ccbr1223_mouse_BatchCorrectedCounts.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_ccbr1223_mouse_BatchCorrectedCounts.R #########################################################################")
...
# Processing input variable: var_ccbr1223_mouse_NormalizedCounts
var_ccbr1223_mouse_NormalizedCounts<-readRDS(paste0(rds_output,"/var_ccbr1223_mouse_NormalizedCounts.rds"))

if (!('Seurat' %in% class(var_ccbr1223_mouse_NormalizedCounts))) { if (!(class(var_ccbr1223_mouse_NormalizedCounts) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_mouse_NormalizedCounts <- as.data.frame(var_ccbr1223_mouse_NormalizedCounts)}}
#############################
...
var_ccbr1223_mouse_BatchCorrectedCounts<-ccbr1223_mouse_BatchCorrectedCounts(var_ccbr1223_mouse_NormalizedCounts,var_ccbr1223_mouse_metadata)
saveRDS(var_ccbr1223_mouse_BatchCorrectedCounts, paste0(rds_output,"/var_ccbr1223_mouse_BatchCorrectedCounts.rds"))
