...
ccbr1223_human_FilteredCounts <- function(ccbr1223_human_CleanRawCounts, ccbr1223_human_metadata) {
    ...
    #Basic Parameters:
    counts_matrix = ccbr1223_human_CleanRawCounts
...
#print(colnames(df.final))
    ...
    png(
      filename="ccbr1223_human_FilteredCounts.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_ccbr1223_human_FilteredCounts.R #########################################################################")
...
# Processing input variable: var_ccbr1223_human_CleanRawCounts
var_ccbr1223_human_CleanRawCounts<-readRDS(paste0(rds_output,"/var_ccbr1223_human_CleanRawCounts.rds"))

if (!('Seurat' %in% class(var_ccbr1223_human_CleanRawCounts))) { if (!(class(var_ccbr1223_human_CleanRawCounts) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_human_CleanRawCounts <- as.data.frame(var_ccbr1223_human_CleanRawCounts)}}
#############################
...
var_ccbr1223_human_FilteredCounts<-ccbr1223_human_FilteredCounts(var_ccbr1223_human_CleanRawCounts,var_ccbr1223_human_metadata)
saveRDS(var_ccbr1223_human_FilteredCounts, paste0(rds_output,"/var_ccbr1223_human_FilteredCounts.rds"))
