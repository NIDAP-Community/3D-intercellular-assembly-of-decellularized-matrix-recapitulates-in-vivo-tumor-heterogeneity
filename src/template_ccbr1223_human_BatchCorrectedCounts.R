...
ccbr1223_human_BatchCorrectedCounts <- function(ccbr1223_human_NormalizedCounts, ccbr1223_human_metadata) {
    ...
    #Basic Parameters:
    counts_matrix <- ccbr1223_human_NormalizedCounts
    sample_metadata <- ccbr1223_human_metadata
    gene_names_column <- "Gene" 
    columns_to_include <- c("Gene","Ensembl_ID_version","Ensembl_ID","ECM_HT29_1","ECM_HT29_2","ECM_HT29_3","ECM_HT29_4","ECM_HT29_5","ECM_HT29_6","CA_HT29_1","CA_HT29_2","CA_HT29_3","CA_HT29_4","CA_HT29_5","CA_HT29_6")
    ...
    png(
      filename="ccbr1223_human_BatchCorrectedCounts.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_ccbr1223_human_BatchCorrectedCounts.R #########################################################################")
...
# Processing input variable: var_ccbr1223_human_NormalizedCounts
var_ccbr1223_human_NormalizedCounts<-readRDS(paste0(rds_output,"/var_ccbr1223_human_NormalizedCounts.rds"))

if (!('Seurat' %in% class(var_ccbr1223_human_NormalizedCounts))) { if (!(class(var_ccbr1223_human_NormalizedCounts) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_human_NormalizedCounts <- as.data.frame(var_ccbr1223_human_NormalizedCounts)}}
#############################
...
var_ccbr1223_human_BatchCorrectedCounts<-ccbr1223_human_BatchCorrectedCounts(var_ccbr1223_human_NormalizedCounts,var_ccbr1223_human_metadata)
saveRDS(var_ccbr1223_human_BatchCorrectedCounts, paste0(rds_output,"/var_ccbr1223_human_BatchCorrectedCounts.rds"))
