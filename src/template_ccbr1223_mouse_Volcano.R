...
ccbr1223_mouse_Volcano <- function(ccbr1223_mouse_DEG) {
    # image: png
    ...
    #Basic Parameters:
    df.orig <- ccbr1223_mouse_DEG
    label.col <- "Gene"
    sig.col <- c("ECM_MC38-CA_MC38_pval","ECM_CT26-CA_CT26_pval")
    pCutoff  = 0.001
    lfc.col <- c("ECM_MC38-CA_MC38_logFC","ECM_CT26-CA_CT26_logFC")
    FCcutoff = 1.0
...
print("template_ccbr1223_mouse_Volcano.R #########################################################################")
...
var_ccbr1223_mouse_Volcano<-ccbr1223_mouse_Volcano(var_ccbr1223_mouse_DEG)
saveRDS(var_ccbr1223_mouse_Volcano, paste0(rds_output,"/var_ccbr1223_mouse_Volcano.rds"))
