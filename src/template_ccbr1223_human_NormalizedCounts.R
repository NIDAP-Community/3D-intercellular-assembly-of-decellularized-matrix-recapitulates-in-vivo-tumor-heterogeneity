...
ccbr1223_human_NormalizedCounts <- function(ccbr1223_human_FilteredCounts, ccbr1223_human_metadata) {
    ...
    #Basic Parameters:
    counts_matrix <- ccbr1223_human_FilteredCounts
...
counts_matrix[,gene_names_column]=paste0(counts_matrix[,gene_names_column],'_',1:nrow(counts_matrix))
    ...
    png(
      filename="ccbr1223_human_NormalizedCounts.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_ccbr1223_human_NormalizedCounts.R #########################################################################")
...
# Processing input variable: var_ccbr1223_human_FilteredCounts
var_ccbr1223_human_FilteredCounts<-readRDS(paste0(rds_output,"/var_ccbr1223_human_FilteredCounts.rds"))

if (!('Seurat' %in% class(var_ccbr1223_human_FilteredCounts))) { if (!(class(var_ccbr1223_human_FilteredCounts) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_human_FilteredCounts <- as.data.frame(var_ccbr1223_human_FilteredCounts)}}
#############################
...
var_ccbr1223_human_NormalizedCounts<-ccbr1223_human_NormalizedCounts(var_ccbr1223_human_FilteredCounts,var_ccbr1223_human_metadata)
saveRDS(var_ccbr1223_human_NormalizedCounts, paste0(rds_output,"/var_ccbr1223_human_NormalizedCounts.rds"))
