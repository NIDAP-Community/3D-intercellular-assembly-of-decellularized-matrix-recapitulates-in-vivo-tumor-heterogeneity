...
ccbr1223_human_CleanRawCounts <- function(ccbr1223_human_rawcounts) {
...
#Basic Parameters:
raw_counts_matrix=ccbr1223_human_rawcounts
...
print("template_ccbr1223_human_CleanRawCounts.R #########################################################################")
...
# Processing input variable: var_ccbr1223_human_rawcounts
var_ccbr1223_human_rawcounts<-readRDS(paste0(rds_output,"/var_ccbr1223_human_rawcounts.rds"))

if (!('Seurat' %in% class(var_ccbr1223_human_rawcounts))) { if (!(class(var_ccbr1223_human_rawcounts) %in% c('data.frame', 'RFilePath', 'character', 'list'))) {var_ccbr1223_human_rawcounts <- as.data.frame(var_ccbr1223_human_rawcounts)}}
#############################

# Saving Output Dataset
invisible(graphics.off())
var_ccbr1223_human_CleanRawCounts<-ccbr1223_human_CleanRawCounts(var_ccbr1223_human_rawcounts)
saveRDS(var_ccbr1223_human_CleanRawCounts, paste0(rds_output,"/var_ccbr1223_human_CleanRawCounts.rds"))
