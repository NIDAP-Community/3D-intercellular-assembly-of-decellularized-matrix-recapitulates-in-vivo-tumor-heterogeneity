...
ccbr1223_human_PCA3D <- function(ccbr1223_human_BatchCorrectedCounts, ccbr1223_human_metadata) {
...
Sample_Metadata_Table <- ccbr1223_human_metadata
...
print("template_ccbr1223_human_PCA3D.R #########################################################################")
...
var_ccbr1223_human_PCA3D<-ccbr1223_human_PCA3D(var_ccbr1223_human_BatchCorrectedCounts,var_ccbr1223_human_metadata)
saveRDS(var_ccbr1223_human_PCA3D, paste0(rds_output,"/var_ccbr1223_human_PCA3D.rds"))
