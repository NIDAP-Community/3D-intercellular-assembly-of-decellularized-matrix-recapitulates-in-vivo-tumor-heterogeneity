...
ccbr1223_human_DEGGeneList <- function(ccbr1223_human_DEG) {
...
print("template_ccbr1223_human_DEGGeneList.R #########################################################################")
...
var_ccbr1223_human_DEGGeneList<-ccbr1223_human_DEGGeneList(var_ccbr1223_human_DEG)
saveRDS(var_ccbr1223_human_DEGGeneList, paste0(rds_output,"/var_ccbr1223_human_DEGGeneList.rds"))
